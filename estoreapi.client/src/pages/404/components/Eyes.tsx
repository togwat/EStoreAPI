...
export default function Eyes() {
    ...
    function Eye() {
        return (
            <div className="rounded-full border-8 border-foreground bg-transparent w-40 h-40" style={{ transform: `rotate(${eyeDeg}deg)` }}>
    ...
    return (
        <div className="flex flex-row gap-16" ref={rectRef}>
            <Eye />
            <Eye />
        </div>
    )
