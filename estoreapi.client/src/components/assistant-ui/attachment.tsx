  ...
  return (
    <ComposerPrimitive.AddAttachment asChild>
      <TooltipIconButton
        ...
        variant="ghost"
        size="icon"
        className="aui-composer-add-attachment size-8 rounded-full p-1 font-semibold text-xs hover:bg-muted-foreground/15 border-muted-foreground/15 hover:bg-muted-foreground/30"
