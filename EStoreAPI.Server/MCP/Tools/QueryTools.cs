...
public class QueryTools
{
    ...
    [McpServerTool, Description("""
        ...
        - "Jobs": "JobId" int PK, "CustomerId" int FK -> Customers, "DeviceId" int FK -> Devices, "ReceiveTime" timestamptz, "PickupTime" timestamptz NULL, "EstimatedPickupTime" timestamptz NULL, "Note" text NULL, "EstimatedPrice" numeric NULL, "CollectedPrice" numeric NULL, "Status" string, "WarrantyOfJobId" int FK -> Jobs
